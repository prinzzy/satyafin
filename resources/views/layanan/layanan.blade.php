...
<body>
    ...
    <main>
        <div class="hero-section">
            <div class="hero-text">
                <h1>Services</h1>
                <p>Satya Management Consultant Services</p>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 service">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Financial & Management Consulting</h5>
                                <p class="card-text">Financial & Management Consulting is a service
                                ...
                                <a href="{{ route('consulting') }}" class="btn-card">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 service">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Business Process FlowChart SOP</h5>
                                <p class="card-text">A SOP Business Process FlowChart is a visual
                                ...
                                <a href="{{ route('flowchart') }}" class="btn-card">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 service">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Financial Report Template</h5>
                                <p class="card-text">A Financial Report Template is a tool used
                                ...
                                <a href="{{ route('report') }}" class="btn-card">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
